        ...
        <div className="shadow-lg secondary-color " style={{ position: "relative" }}>
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="container-fluidity mt-5">
                <p>
                ...
                <div className="row below-section">
                  <div className="col-12 col-lg-3 btn-border d-flex justify-content-center align-items-center text-center p-2">
                    <div className="boxing" onClick={() => navigate("/audit")}>
                      Review Campaign for CO2 emission calculaation
                    </div>
                  </div>
                  <div className="col-12 col-lg-3 btn-border d-flex justify-content-center align-items-center text-center p-2">
                    <div className="boxing" onClick={() => navigate("/audit")}>
                  ...
                  <div className="col-12 col-lg-3 btn-border d-flex justify-content-center align-items-center text-center p-2">
                    <div className="boxing" onClick={() => navigate("/audit")}>
                      Validate Human Rights & Living Wages Compliancy
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-md-6">
              <div className="setModuleheighttp">
                <div className="bg-white p-4 rounded text-left">
                  <p className="font-weight-bold mb-3">
                    <b>Module</b>
                    <span className="linkclickpst">imde.io</span>
                  </p>
                  <p className="font-weight-bold mb-3">
                    <b>Output</b>
                  </p>
                  {errorcheck && <p className="warnred">You need to select any one of the options</p>}
